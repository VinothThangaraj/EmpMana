...
namespace EmpManagement
{
    ...
    public class SwaggerConfig
    {
        ...
        public static void Register()
        {
            var thisAssembly = typeof(SwaggerConfig).Assembly;
                ...
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion("V1", "EmpManagement");
        ...
        {
            var rootUrl = ConfigurationManager.AppSettings["BaseURLForSwagger"];
            return rootUrl;
        }

        private static string GetXmlCommentsPath()
        {
            return String.Format(@"{0}\bin\EmpManagement.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
    }
}
